...
; An AL Program that declares and initialize an array of size
              ; 10, then display the contents of the array before and after 
              ; sorting it in ascending order by using Bubble Sort method.
